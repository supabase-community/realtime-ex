...
1. Incoming Message Dispatch:
   When a message is received: - The Connection Manager passes it to the Channel Registry. - The registry decodes the payload and identifies the topic and event. - Registered callbacks for the specific topic and event are invoked.
